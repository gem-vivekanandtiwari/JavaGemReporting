...
public class GemReportingTest {
	...
	public static void main(String[] args) throws IOException {
		// TODO Auto-generated method stub
		  ...
		  false); GemTestReporter.addTestStep("Step1", "stepDescription1", STATUS.PASS);
		  GemTestReporter.addTestStep("Step2", "stepDescription2", STATUS.PASS);
		  GemTestReporter.addTestStep("Step3", "stepDescription3", STATUS.FAIL);
		  ...
		  GemTestReporter.endTestCase(); GemTestReporter.endSuite();
